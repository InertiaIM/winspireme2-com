...
<p><em><strong>Airfare:</strong> Peak round-trip rates during premium travel season and participating cities are used for the 48 contiguous United States, Hawaii, Canada, Caribbean, Mexico, Central America, South America, Europe, Pacific (Asia, Australia, South Pacific Islands).</em></p>
...
<p><em>All rates are based on the high season that the package is eligible for redemption.</em></p>
<p><em>The suggested value is just one part of the full written description for our packages. Suggested values are calculated this way because hotel and air costs can vary greatly throughout the year and from different departure cities. We recommend that starting bids for our trips be based on the non-profit price and not based on the suggested value.</em></p>
...
(The Reservation Confirmation Email contains links for each experience to view and download detailed descriptions as well as promotional pieces. Please note, experience description details are subject to change and should be downloaded or reviewed again just prior to usage in your event.)</p>
